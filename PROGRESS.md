...
> Snapshot: session branch `claude/project-onboarding-lcnvi7` · `main` @ `0e3db29` · last green build **#218** (all 3 jobs green; emulator ran **8 instrumented tests, 0 failed** — wake-word load+detect **and** Compose UI) · updated 2026-08-09

...
> Snapshot: session branch `claude/project-onboarding-lcnvi7` · `main` @ `556f24c` · last green build **#214** (all 3 jobs green: `build`, `wakeword-pipeline`, emulator load+detect) · updated 2026-08-09

...
> Snapshot: session branch `claude/jarvis-os-files-ata1ho` · `main` @ `bcb599b` · last green build **#248** (`build`, `wakeword-pipeline`, `instrumented` all green; `e2e-tap` non-gating and still being brought up) · updated 2026-08-14

...
> Snapshot: session branch `claude/project-onboarding-lcnvi7` · `main` @ `7e05300` · last green build **#211** (all 3 jobs green: `build`, `wakeword-pipeline`, emulator load+detect) · updated 2026-08-09

...
- **Awaiting CI:** `221f16d` — the three guards plus the fix that ended a six-build red streak (#163–#169). The cause was `compileDebugUnitTestKotlin`: `AskGuard.apply` is generic and a test passed a bare `emptyList()`. `main` never left green at `31f3b05`.

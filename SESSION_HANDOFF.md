...
- **Awaiting CI:** `3284ed3` (the artwork-as-orb switch). Compilation is the only mechanical check that matters here — **how it looks and whether it holds framerate cannot be verified in this environment** and are the user's to judge.

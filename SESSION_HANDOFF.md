...
- **`main` @ `46e1ffc`** (green build **#171**, artifact confirmed) — everything is merged, including the three device-session guards (`AlarmGuard`, `AskGuard`, alarm-volume check).
...
- **Awaiting CI:** `2166dd9` — the Settings lag fix (see below).
